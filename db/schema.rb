...
ActiveRecord::Schema.define(version: 20_180_907_093_829) do
  ...
  create_table 'dynamic_data', force: :cascade do |t|
    t.datetime 'created_at', null: false
  ...
  create_table 'spree_option_type_prototypes', force: :cascade do |t|
    ...
    t.index %w[prototype_id option_type_id], name: 'spree_option_type_prototypes_prototype_id_option_type_id', unique: true
  ...
  create_table 'spree_option_value_variants', force: :cascade do |t|
    ...
    t.index %w[variant_id option_value_id], name: 'index_option_values_variants_on_variant_id_and_option_value_id', unique: true
  ...
  create_table 'spree_order_promotions', force: :cascade do |t|
    ...
    t.index %w[promotion_id order_id], name: 'index_spree_order_promotions_on_promotion_id_and_order_id'
  ...
  create_table 'spree_product_promotion_rules', force: :cascade do |t|
    ...
    t.index %w[promotion_rule_id product_id], name: 'index_products_promotion_rules_on_promotion_rule_and_product'
  end
  ...
  create_table 'spree_promotion_rule_users', force: :cascade do |t|
    ...
    t.index %w[user_id promotion_rule_id], name: 'index_promotion_rules_users_on_user_id_and_promotion_rule_id'
  end
  ...
  create_table 'spree_property_prototypes', force: :cascade do |t|
    ...
    t.index %w[prototype_id property_id], name: 'index_property_prototypes_on_prototype_id_and_property_id', unique: true
  ...
  create_table 'spree_prototype_taxons', force: :cascade do |t|
    t.integer 'taxon_id'
    t.integer 'prototype_id'
    t.index %w[prototype_id taxon_id], name: 'index_spree_prototype_taxons_on_prototype_id_and_taxon_id'
  ...
  create_table 'spree_reimbursement_credits', force: :cascade do |t|
    ...
    t.index %w[creditable_id creditable_type], name: 'index_reimbursement_credits_on_creditable_id_and_type'
  ...
  create_table 'spree_shipping_method_categories', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[shipping_category_id shipping_method_id], name: 'unique_spree_shipping_method_categories', unique: true
  ...
  create_table 'spree_stock_movements', force: :cascade do |t|
    ...
    t.index %w[originator_id originator_type], name: 'index_stock_movements_on_originator_id_and_originator_type'
  ...
  create_table 'spree_store_credit_events', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[originator_id originator_type], name: 'spree_store_credit_events_originator'
  ...
  create_table 'spree_store_credits', force: :cascade do |t|
    ...
    t.index %w[originator_id originator_type], name: 'spree_store_credits_originator'
  ...
  create_table 'spree_taggings', force: :cascade do |t|
    ...
    t.index %w[tag_id taggable_id taggable_type context tagger_id tagger_type], name: 'spree_taggings_idx', unique: true
    t.index ['tag_id'], name: 'index_spree_taggings_on_tag_id'
    t.index %w[taggable_id taggable_type tagger_id context], name: 'spree_taggings_idy'
    ...
    t.index %w[tagger_id tagger_type], name: 'index_spree_taggings_on_tagger_id_and_tagger_type'
